...
public class VideoController  implements Initializable  {
     ...
     */
    private static final String VIDEO_FILE = "testvid.avi";


    String debug_style_border = "-fx-border-color: red;"
            + "-fx-border-width: 1;"
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        player.getMediaPlayerComponent().getMediaPlayer().playMedia("C:\\Users\\ubu\\KlearKapture\\KlearClient\\test.mp4 ");
